...
public class InquPage {
    ...
    private InquCriteria criteria;

    public InquPage(InquCriteria criteria, int total){
        this(criteria, total, 5);
    }

    public InquPage(InquCriteria criteria, int total, int pageCount) {
